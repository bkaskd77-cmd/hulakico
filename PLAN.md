...
**Status:** Step 2 complete (awaiting approval). Next: Step 3.
...
| 2 | Python FastAPI skeleton + `/health` | **DONE** (awaiting approval) |
| 3 | User/Org + session auth | Pending |
| 4 | Carrier/rate models + adapter interface + seeds | Pending |
| 5 | Booking draft wizard saves `DRAFT` | Pending |
