    ...
    <section>
      ...
      <div className="mt-3 grid gap-4 sm:grid-cols-2">
        <label className="text-sm text-[var(--muted)]">
          ...
          <input
            className={field}
            value={form[k.contactName]}
            onChange={(e) => update(k.contactName, e.target.value)}
            required
            minLength={2}
          />
        </label>
        <label className="text-sm text-[var(--muted)]">
          ...
          <input
            className={field}
            value={form[k.company]}
            onChange={(e) => update(k.company, e.target.value)}
          />
        </label>
        <label className="text-sm text-[var(--muted)]">
          Phone
          <input
            className={field}
            value={form[k.phone]}
            onChange={(e) => update(k.phone, e.target.value)}
            required
            minLength={7}
          />
        </label>
        <label className="text-sm text-[var(--muted)]">
          ...
          <input
            ...
            type="email"
            value={form[k.email]}
            onChange={(e) => update(k.email, e.target.value)}
          />
        </label>
        <label className="text-sm text-[var(--muted)]">
          Country (ISO)
        ...
        <label className="text-sm text-[var(--muted)]">
          ...
          <input
            className={field}
            value={form[k.postal]}
            onChange={(e) => update(k.postal, e.target.value)}
          />
        </label>
        <label className="sm:col-span-2 text-sm text-[var(--muted)]">
          ...
          <input
            className={field}
            value={form[k.line1]}
            onChange={(e) => update(k.line1, e.target.value)}
            required
            minLength={5}
